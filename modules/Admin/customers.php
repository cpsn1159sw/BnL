...
<body>
  ...
  <div class="wrapper d-flex align-items-stretch">
    ...
    <div id="content" class="p-4 p-md-5">
      ...
      ?>
      <p><a href="<?php echo _WEB_HOST?>/customers/create" target="_blank" class="btn btn-success">Add user <span class="tf-ion-plus"></span></a></p>
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <a href="<?php echo _WEB_HOST?>/customers/edit&id=<?php echo $item['CustomerID']; ?>" class="btn btn-warning"><i class="tf-ion-edit" aria-hidden="true"></i></a>
                    </div>
                  </td>
                  <td>
                    <div class="btn-group" role="group">
                      <a href="<?php echo _WEB_HOST?>/customers/delete&id=<?php echo $item['CustomerID']; ?>" onclick="return confirm('Are you sure you want to delete?')" class="btn btn-danger"><i class="tf-ion-trash-b" aria-hidden="true"></i></a>
                    </div>
                  </td>
                </tr>
            <?php
